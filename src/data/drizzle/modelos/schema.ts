...
export const sportPositions = pgTable(
  ...
  (t) => ({
    pk: primaryKey({ columns: [t.sportId, t.positionsId] }),
  })
);
...
export const sportMatchRules = pgTable(
  ...
  (t) => ({
    pk: primaryKey({ columns: [t.sportId, t.matchRulesId] }),
  })
);
...
export const sportTypeMatchEvents = pgTable(
  ...
  (t) => ({
    pk: primaryKey({ columns: [t.sportId, t.typeMatchEventId] }),
  })
);
...
export const matchRulesChampionshipSports = pgTable(
  ...
  (t) => ({
    pk: primaryKey({ columns: [t.matchRulesId, t.championshipId, t.sportId] }),
  })
);
...
export const teamGroupTeams = pgTable(
  ...
  (t) => ({
    pk: primaryKey({ columns: [t.teamId, t.groupTeamId] }),
  })
);
